...
Node {
    id: rootNode
    property int rotation1: 60
    property int rotation2: 45
    property int rotation3: 45
    property int rotation4: 0
    ...
    Model {
        ...
        scale.y: 100
        scale.z: 100
        source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/base.mesh"
        eulerRotation.x: -90
        ...
        Model {
            ...
            source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/root.mesh"
            ...
            Model {
                ...
                source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/forearm.mesh"
                ...
                Model {
                    ...
                    source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/arm.mesh"

                    DefaultMaterial {
                        id: plastic_qt_material
                        diffuseMap: Texture {
                            source: "qrc:/qt/qml/VoiceAILLM/content/3d/maps/qt.png"
                            pivotU: 0.5
                            pivotV: 0.5
                    ...
                    Model {
                        ...
                        source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/hand_hinge.mesh"
                        ...
                        Model {
                            ...
                            y: 2.38419e-07
                            z: 0.366503
                            source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/hand.mesh"
                            materials: [plastic_material, steel_material]
                            ...
                            Model {
                                ...
                                source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/hand_grab_t_hinge_2.mesh"
                            ...
                            Model {
                                ...
                                source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/hand_grab_t_hinge_1.mesh"
                                materials: [steel_material]
                                ...
                                Model {
                                    ...
                                    source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/hand_grab_t.mesh"
                            ...
                            Model {
                                ...
                                source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/hand_grab_b_hinge_1.mesh"
                                materials: [steel_material]
                                ...
                                Model {
                                    ...
                                    source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/hand_grab_b.mesh"
                                    materials: [plastic_color_material, steel_material]
                                }
                            }
                            ...
                            Model {
                                ...
                                source: "qrc:/qt/qml/VoiceAILLM/content/3d/meshes/hand_grab_b_hinge_2.mesh"
                                materials: [steel_material]
                            }
                        }
                    }
